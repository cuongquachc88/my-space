 ...
 *
 * Deploy: npx wrangler deploy (configured in Cloudflare Dashboard)
 * Env vars (Dashboard → Worker → Settings → Variables and Secrets):
 *   VITE_GOOGLE_CLIENT_ID   — Google OAuth web client id
 *   GOOGLE_CLIENT_SECRET    — Google OAuth web client secret (use Secret type)
 */
