...
A private, offline-first Chrome extension that lives in the side panel. Stores notes, secrets, passwords, and subscriptions — all encrypted on your device. Optional Google Drive backup, fully end-to-end encrypted.
